...
const BATTLE_REWARD_SCENE := preload("res://scenes/BattleReward/battle_reward.tscn")
const CAMPFIRE_SCENE := preload("res://scenes/Campfire/campfire.tscn")
const MAP_SCENE := preload("res://scenes/Map/map.tscn")
const SHOP_SCENE := preload("res://scenes/Shop/shop.tscn")
const TREASURE_SCENE := preload("res://scenes/Trreasure/treasure.tscn")
...
func _on_map_exited() -> void:
	print("TODO: from map, change view based on room")
